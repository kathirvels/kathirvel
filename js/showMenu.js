		...
		if(itemDet.option=='N') {
            ...
            htmlVal+='<h2>Size</h2></div>';
				$.each(itemOptionDets, function(index, itemOpt) {
					...
					htmlVal+='<div class="row_div"><p class="info_right"><input type="radio" name="option_price" id="'+itemOpt.option_name+'" value="'+itemOpt.price + '" data-cacheval="true" onclick=\'setPriceType("'+OptionName+'")\' '+priceSelected+'/> '+itemOpt.option_name+'</p>';
					htmlVal+='$'+ itemOpt.price;					
					htmlVal+='</div>';	
